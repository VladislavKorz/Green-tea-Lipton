...
TELEGRAM_BOT_API_KEY =  "6282472890:AAEyRKGVFBONpJi3gwZP4rt-YzhVMYzPjVk"
    ...
    'default': {
        ...
        'image': {
            'toolbar': ['imageTextAlternative', '|', 'imageStyle:alignLeft',
                        'imageStyle:alignRight', 'imageStyle:alignCenter', 'imageStyle:side', 'toggleImageCaption', 'imageTextAlternative'  '|'],
            'styles': [
                'full',
                'side',
                'alignLeft',
